...
use bevy::{math::{primitives::Sphere, Vec3A}, prelude::*};
...
fn watch_beat_changes(mut beat_reader: EventReader<BeatCreated>, mut commands: Commands, mut clear_beats_reader: EventReader<BeatsCleared>, entity_query: Query<Entity, With<Timed>>) {
